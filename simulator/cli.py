...
from .core import *
def main():
 ap=argparse.ArgumentParser(); ap.add_argument('fixture'); ap.add_argument('--html'); ap.add_argument('--trace-out'); ap.add_argument('--verify-trace'); args=ap.parse_args(); d=json.load(open(args.fixture))
 ...
 if args.verify_trace:
  saved=json.load(open(args.verify_trace)); expected=saved['result']['trace']['traceId']; actual=out['trace']['traceId']
